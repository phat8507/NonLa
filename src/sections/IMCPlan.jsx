  ...
  const flowPhases = [
    {
      month: "Sep",
      phase: "Phase 1",
      name: "Demand Awakening",
      obj: "Establish category premium tier",
      channel: "TikTok / FB / PR",
      kpi: "Awareness & Reach"
    },
    {
      month: "Oct",
      phase: "Phase 2",
      name: "Trial + Proof",
      obj: "Dispel format cheapness stigma",
      channel: "ShopeeFood / KOC",
      kpi: "Sampling CVR"
    },
    {
      month: "Nov",
      phase: "Phase 3",
      name: "B2B Peak",
      obj: "Secure high-volume bulk deals",
      channel: "Direct Sales / LinkedIn / Email",
      kpi: "Lead Volume & Quotes"
    },
    {
      month: "Dec",
      phase: "Phase 4",
      name: "Last-mile Gifting",
      obj: "Fulfill premium deliveries safely",
      channel: "Pop-up / Google Ads",
      kpi: "Logistical Success Rate"
    }
  ];
...
const ChannelRoleMap = () => {
  const channels = [
    // Reach
    { name: "TikTok", x: 45, y: 85, type: "reach", label: "TikTok" },
    { name: "Facebook", x: 55, y: 78, type: "reach", label: "Facebook" },
    { name: "YouTube", x: 50, y: 70, type: "reach", label: "YouTube" },
    // Trust
    { name: "PR", x: 35, y: 55, type: "trust", label: "PR" },
    { name: "KOC", x: 62, y: 62, type: "trust", label: "KOC" },
    // Conversion
    { name: "Google", x: 78, y: 35, type: "conversion", label: "Google" },
    { name: "Landing page", x: 84, y: 28, type: "conversion", label: "Landing Page" },
    { name: "Direct B2B", x: 92, y: 20, type: "conversion", label: "Direct B2B" },
    { name: "Zalo", x: 72, y: 45, type: "conversion", label: "Zalo" }
  ];
...
const IMCPlan = () => {
  ...
  const phases = [
    {
      id: 1,
      name: "SEP",
      title: "Demand Awakening",
      budget: "800M (20%)",
      message: "Redefine Gifting Standards — Perfect Giver Prestige (Định chuẩn quà tặng — vẹn toàn thể diện)",
      tactics: [
    ...
    },
    {
      ...
      title: "Trial + Proof",
      budget: "1B (25%)",
      message: "Trọn tinh túy Việt dưới bóng nón lá (The full essence of Vietnam, sheltered under the nón lá)",
      tactics: [
    ...
    },
    {
      ...
      budget: "1.4B (35%)",
      isPeak: true,
      message: "Che chở bản sắc, thăng hoa ân tình (Protecting identity, elevating gratitude)",
      tactics: [
    ...
    },
    {
      id: 4,
      name: "DEC",
      title: "Last-mile Gifting",
      budget: "800M (20%)",
      message: "Nón lá in hand — sending wishes rich in Vietnamese essence (Nón lá trao tay — gửi lời chúc đượm vị tinh hoa)",
      tactics: [
  ...
  const channelsData = [
    { name: "TikTok", role: "Awareness + Trial", roleColor: "text-[#F4B400]", why: "Gen Z/Millennial reach, unboxing virality" },
    { name: "Facebook", role: "Awareness + Community", roleColor: "text-[#F4B400]", why: "HR community targeting, broad Tet reach" },
    { name: "Google", role: "Conversion", roleColor: "text-white/85", why: "Search intent capture, remarketing" },
    { name: "Landing page", role: "Conversion", roleColor: "text-white/85", why: "B2B lead capture, product showcase" },
    { name: "Zalo", role: "CRM + Nurture", roleColor: "text-white", why: "Vietnamese messaging dominance, direct follow-up" },
    { name: "KOC", role: "Consideration", roleColor: "text-white/75", why: "Authentic product proof, UGC generation" },
    { name: "PR", role: "Authority", roleColor: "text-[#F4B400]", why: "Brand credibility, premium positioning" },
    { name: "Direct B2B", role: "Conversion", roleColor: "text-white/85", why: "Personal relationship, sample delivery" }
  ];

  const legendItems = [
    { label: 'Awareness', percentage: '32%', value: '1.28B', color: '#F4B400' },
    { label: 'Consideration', percentage: '23%', value: '0.92B', color: '#1A4DFF' },
    { label: 'Conversion', percentage: '30%', value: '1.20B', color: '#0033CC' },
    { label: 'Advocacy', percentage: '8%', value: '0.32B', color: '#8A9BB5' },
    { label: 'Contingency', percentage: '7%', value: '0.28B', color: '#F5F7FA' }
  ];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-start gap-8 mb-8" ref={chartRef}>
          <div className="glass-card p-4 lg:p-5 flex flex-col justify-between border border-[#FFD84D]/10 overflow-hidden">
            <h3 className="text-lg font-bold text-white mb-2">Budget by Funnel</h3>
